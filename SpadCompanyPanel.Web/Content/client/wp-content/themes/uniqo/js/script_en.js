...
$(function(){ 
  ...
  tp1_in_tl
    ...
    // .fromTo('#softlan_logo',2,{opacity:0},{opacity:1,ease: Power1.easeOut},"+=.5")
    ...
    // .fromTo('.menu_btn',.5,{visibility:'hidden'},{visibility:'visible'})
    // .fromTo('.language_icon',2,{opacity:0},{opacity:1,ease: Power1.easeOut})

    // .fromTo('#menu_table_welcome',1.4,{x:-700,opacity:0},{x:0,opacity:1,onComplete:function(){
    //   tp1_in_tl.play();
    // }},"-=1.7")
    // ;
    if(wid<650){
  ...
  // .addIndicators()
    ...
    if(event.scrollDirection==='FORWARD'){
      ...
      .to('#footer1_image',1,{opacity:1,ease :Power4.easeOut})
        .to('#video_svg1',1,{left:'-22%',ease :Power4.easeOut})
  ...
  // .addIndicators()
    ...
    if(event.scrollDirection==='FORWARD'){
      ...
      video_svg2_in
        ...
        .to('#video_svg2',1,{left:'-22%',ease :Power4.easeOut})
  ...
  // .addIndicators()
    ...
    if(event.scrollDirection==='FORWARD'){
      ...
      video_svg3_in
        ...
        .to('#video_svg3',1,{left:'-22%',ease :Power4.easeOut})
...
//   }); 
  ...
  $(window).scroll(function(){
      ...
      if(topscroll<$('.top_page:eq(1)').offset().top-10){
        $( ".gr_border" ).not( ":eq(0)" ).removeClass('gr_active');
        $( ".gr_border:eq(0)" ).addClass( "gr_active" );
      }
      else if(topscroll<$('.top_page:eq(2)').offset().top-1){
        $( ".gr_border" ).not( ":eq(1)" ).removeClass('gr_active');
        $( ".gr_border:eq(1)" ).addClass( "gr_active" );

      }else{
        $( ".gr_border" ).not( ":eq(2)" ).removeClass('gr_active');
        $( ".gr_border:eq(2)" ).addClass( "gr_active" );
